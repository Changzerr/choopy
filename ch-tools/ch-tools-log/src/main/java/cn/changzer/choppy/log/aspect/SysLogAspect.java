package cn.changzer.choppy.log.aspect;


import cn.changzer.choppy.content.BaseContextHandler;
import cn.changzer.choppy.log.entity.OptLogDTO;
import cn.changzer.choppy.log.event.SysLogEvent;
import cn.changzer.choppy.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(cn.changzer.choppy.log.annotation.SysLog)")
