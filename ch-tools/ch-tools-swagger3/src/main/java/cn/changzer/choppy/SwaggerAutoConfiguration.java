...
import cn.changzer.choppy.swagger2.Swagger2Configuration;
import cn.changzer.choppy.swagger2.SwaggerProperties;
...
public class SwaggerAutoConfiguration implements BeanFactoryAware {
    ...
    @ConditionalOnProperty(name = "choppy.swagger.enabled", havingValue = "true", matchIfMissing = true)
